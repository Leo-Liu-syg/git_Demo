...
//                FT64F0A5  TSSOP20
//              -------------------
// Key_2-------|1(PA5)   	(PA4)20|-----------Key_1
// NC----------|2(PA6)   	(PA3)19|-----------LED_right
// NC----------|3(PA7)   	(PA2)18|-----------ISP_硬件烧录
// SHT_SDA-----|4(PC0)   	(PA1)17|-----------LED_Mid
// SHT_SCL-----|5(PC1)		(PA0)16|-----------LED_Left
// NC----------|6(PB7)		(PB0)15|-----------Seg2_SCL
// GND---------|7(GND)		(PB1)14|-----------ADC_电压输入
// NC----------|8(PB6)		(PB2)13|-----------Seg2_SDA
// VDD---------|9(VDD)		(PB3)12|-----------seg1_SCL
// Buzz--------|10(PB5)		(PB4)11|-----------Seg2_SDA
//				-------------------
//
//===========================================================
#include "SYSCFG.h"
